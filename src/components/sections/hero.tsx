      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="text-center md:text-left">
            ...
            <p className="mt-4 max-w-xl mx-auto md:mx-0 text-lg md:text-xl text-foreground/90 animate-fade-in" style={{ animationDelay: '0.4s' }}>
          ...
          <div className="relative h-64 md:h-80 lg:h-96 w-full animate-fade-in" style={{ animationDelay: '0.3s' }}>
            {heroImage && (
              <Image
