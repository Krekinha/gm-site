      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="text-center md:text-left">
            <h3 className="font-semibold text-secondary-foreground">Contato</h3>
          ...
          <div className="text-center md:text-left">
             <h3 className="font-semibold text-secondary-foreground">Informações</h3>
             <ul className="mt-4 space-y-2 text-sm text-secondary-foreground/80">
              <li>
        ...
        <div className="mt-8 border-t border-border pt-8 text-center text-sm text-secondary-foreground/60">
          <p>&copy; {new Date().getFullYear()} GM Manutenções. Todos os direitos reservados.</p>
        </div>
      </div>
    </footer>
  );
